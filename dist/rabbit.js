...
/*!***************************************************************!*\
  !*** ./node_modules/@popperjs/core/lib/index.js + 56 modules ***!
  \***************************************************************/
...
var mixins_1 = __webpack_require__(/*! ../../mixins */ "./src/mixins/index.ts");
var dom_utils_1 = __webpack_require__(/*! ../../dom-utils */ "./src/dom-utils/index.ts");
var utils_1 = __webpack_require__(/*! ../../utils */ "./src/utils/index.ts");
var prefix_1 = __importDefault(__webpack_require__(/*! ../prefix */ "./src/components/prefix.ts"));
var Alert = (function () {
    function Alert() {
        this.VERSION = 'v1.0';
        this.components = dom_utils_1.$el('r-alert', { all: true });
        this._create(this.components);
    }
    Alert.prototype.config = function (el) {
        var target = dom_utils_1.$el(el);
        utils_1.validComps(target, 'alert');
        var alertIcon = target === null || target === void 0 ? void 0 : target.querySelector("." + prefix_1.default.alert + "-icon");
        var alertMsg = target === null || target === void 0 ? void 0 : target.querySelector("." + prefix_1.default.alert + "-message");
        var alertDesc = target === null || target === void 0 ? void 0 : target.querySelector("." + prefix_1.default.alert + "-desc");
        return {
            get message() {
                return alertMsg;
            },
            set message(newVal) {
                if (newVal != alertMsg.innerHTML) {
                    dom_utils_1.setHtml(alertMsg, newVal);
                }
                return;
            },
            get desc() {
            ...
            set desc(newVal) {
                if (alertDesc) {
                    if (newVal != dom_utils_1.setHtml(alertDesc)) {
                        dom_utils_1.setHtml(alertDesc, newVal);
                    }
                    return;
                }
                else {
                    mixins_1.warn('Before setting the description of this alert tag, you need to add the attribute "desc" to the tag and add content or Spaces');
                }
            },
            get icon() {
                return alertIcon;
            ...
            set icon(newVal) {
                if (alertIcon) {
                    if (newVal != dom_utils_1.setHtml(alertIcon)) {
                        dom_utils_1.setHtml(alertIcon, newVal);
                    }
                    return;
                }
                else {
                    mixins_1.warn('This alert tag does not set the display icon');
                }
            }
        };
    };
    Alert.prototype.onClose = function (el, cb) {
        ...
        utils_1.validComps(target, 'alert');
        var $this = target;
        var alertCloseBtn = target.querySelector("." + prefix_1.default.alert + "-close");
        alertCloseBtn.addEventListener('click', function () { return utils_1.type.isFn(cb, $this); });
    };
    Alert.prototype._create = function (nodes) {
        ...
        nodes.forEach(function (node) {
            ...
            dom_utils_1.removeAttrs(node, ['message', 'desc', 'show-icon', 'closable', 'close-text']);
        });
    };
    Alert.prototype._setIcon = function (node) {
        ...
        var AlertIcon = dom_utils_1.createElem('span');
        AlertIcon.className = prefix_1.default.alert + "-icon";
        AlertIcon.innerHTML = "<i class=\"rab-icon rab-icon-" + iconType + "\"></i>";
        node.classList.add(prefix_1.default.alert + "-with-icon");
    ...
    Alert.prototype._setMsg = function (node) {
        var AlertMessage = dom_utils_1.createElem('div');
        var content = this._getMsg(node);
        AlertMessage.className = prefix_1.default.alert + "-message";
        dom_utils_1.setHtml(AlertMessage, content);
        node.prepend(AlertMessage);
    };
    Alert.prototype._setDesc = function (node) {
        if (!this._getDesc(node))
            return;
        var AlertDesc = dom_utils_1.createElem('div');
        var content = this._getDesc(node);
        AlertDesc.className = prefix_1.default.alert + "-desc";
        dom_utils_1.setHtml(AlertDesc, content);
        node.classList.add(prefix_1.default.alert + "-with-desc");
        node.appendChild(AlertDesc);
    };
    Alert.prototype._setCloseBtn = function (node) {
        if (!this._isClosable(node))
            return;
        var AlertCloseBtn = dom_utils_1.createElem('a');
        var closeText = this._setCloseText(node);
        AlertCloseBtn.className = prefix_1.default.alert + "-close";
        var text = closeText ? closeText : '<i class="rab-icon rab-icon-ios-close"></i>';
        dom_utils_1.setHtml(AlertCloseBtn, text);
        AlertCloseBtn.addEventListener('click', function () { return utils_1.destroyElem(node, { fadeOut: true }); });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var alert_1 = __importDefault(__webpack_require__(/*! ./alert */ "./src/components/alert/alert.ts"));
...
var Avatar = (function () {
    function Avatar() {
        this.VERSION = 'v1.0';
        this.components = dom_utils_1.$el('r-avatar', { all: true });
        this._create(this.components);
    }
    Avatar.prototype._create = function (nodes) {
        ...
        nodes.forEach(function (node) {
            ...
            dom_utils_1.removeAttrs(node, ['icon', 'src', 'custom-icon']);
        });
    };
    Avatar.prototype._setIcon = function (node) {
        ...
        if (hasIcon || customIcon) {
            dom_utils_1.setHtml(node, '');
            node.classList.add(prefix_1.default.avatar + "-icon");
        }
        if (customIcon) {
            dom_utils_1.setHtml(node, customIcon);
        }
        else {
            var AvatarIcon = dom_utils_1.createElem('i');
    ...
    Avatar.prototype._setImage = function (node) {
        ...
        if (!hasSrc)
            return;
        var AvatarImage = dom_utils_1.createElem('img');
        AvatarImage.src = hasSrc;
        dom_utils_1.setHtml(node, '');
        node.classList.add(prefix_1.default.avatar + "-image");
    ...
    Avatar.prototype._setCustomContent = function (node) {
        if (node.getAttribute('rb-icon') || node.getAttribute('rb-src'))
            return;
        if (dom_utils_1.setHtml(node)) {
            var AvatarStrBox = dom_utils_1.createElem('span');
            AvatarStrBox.className = prefix_1.default.avatar + "-string";
            dom_utils_1.setHtml(AvatarStrBox, node.innerHTML);
            dom_utils_1.setHtml(node, '');
    ...
    Avatar.prototype._setScale = function (node, children) {
        ...
        if (avatarWidth - 8 < childrenWidth) {
            ...
            dom_utils_1.setCss(children, 'transform', "scale(" + newScale + ") translateX(-50%)");
        }
        else {
            dom_utils_1.setCss(children, 'transform', 'scale(1) translateX(-50%)');
        }
    };
    Avatar.prototype._setSize = function (node) {
        ...
        if (!size)
            return;
        dom_utils_1.setCss(node, 'width', size + "px");
        dom_utils_1.setCss(node, 'height', size + "px");
        dom_utils_1.setCss(node, 'lineHeight', size + "px");
        if (size >= 40) {
            if (node.querySelector('.rab-icon')) {
                var newFontSize = Math.floor(size / 2) + "px";
                dom_utils_1.setCss(node, 'fontSize', newFontSize);
            }
        }
    };
    ...
    Avatar.prototype._getSize = function (node) {
        ...
        if (toNum)
            ...
            mixins_1.warn("You have set an invalid size value for the Avatar component --> \"" + size + "\"");
        }
    };
    return Avatar;
}());
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var avatar_1 = __importDefault(__webpack_require__(/*! ./avatar */ "./src/components/avatar/avatar.ts"));
...
var Badge = (function () {
    function Badge() {
        this.VERSION = 'v1.0';
        this.components = dom_utils_1.$el('r-badge', { all: true });
        this._create(this.components);
    }
    Badge.prototype.config = function (el) {
        var target = dom_utils_1.$el(el);
        utils_1.validComps(target, 'badge');
        var countContainer = target.querySelector("." + prefix_1.default.badge + "-count");
        var dotContainer = target.querySelector("." + prefix_1.default.badge + "-dot");
        ...
        return {
            ...
            set count(newVal) {
                if (countContainer && utils_1.type.isNum(newVal)) {
                    if (newVal > maxCount) {
                        _setMaxCount(countContainer, maxCount);
                    }
                    else {
                        dom_utils_1.setText(countContainer, "" + newVal);
                        if (newVal <= 0 && !showZero) {
                            dom_utils_1.setCss(countContainer, 'display', 'none');
                        }
                        else {
                            dom_utils_1.setCss(countContainer, 'display', '');
                        }
                    }
                }
                else {
                    mixins_1.warn("The count value of this badge cannot be set --> \"" + el + "\"");
                }
            },
            get text() {
                return countContainer === null || countContainer === void 0 ? void 0 : countContainer.textContent;
            ...
            set text(newVal) {
                if (!utils_1.type.isStr(newVal)) {
                    mixins_1.warn("The text value of this badge cannot be set --> \"" + el + "\"");
                    return;
                }
                dom_utils_1.setText(countContainer, newVal);
            },
            ...
            set dot(newVal) {
                if (!dotContainer) {
                    mixins_1.warn("Unable to set this badge to dot --> \"" + el + "\"");
                    return;
                }
                if (utils_1.type.isBol(newVal) && newVal) {
                    dom_utils_1.setCss(dotContainer, 'display', '');
                }
                else {
                    dom_utils_1.setCss(dotContainer, 'display', 'none');
                }
            }
        };
    };
    ...
    Badge.prototype._setCount = function (node) {
        ...
        var BadgeCount = dom_utils_1.createElem('sup');
        BadgeCount.className = prefix_1.default.badge + "-count";
        if (count || count === 0) {
            if (count > maxCount) {
                ...
                if (count <= 0 && !this._showZero(node)) {
                    dom_utils_1.setCss(BadgeCount, 'display', 'none');
                }
                else {
                    dom_utils_1.setText(BadgeCount, "" + count);
                }
            }
    ...
    Badge.prototype._setMaxCount = function (node, maxCount) {
        dom_utils_1.setText(node, maxCount + "+");
    };
    Badge.prototype._setDot = function (node, children) {
        if (!this._showDot(node))
            return;
        dom_utils_1.setHtml(children, '');
        dom_utils_1.setCss(children, 'display', '');
        children.className = prefix_1.default.badge + "-dot";
    };
    Badge.prototype._setText = function (parent, children) {
        if (!this._getStatus(parent) && !this._getColor(parent)) {
            ...
            if (text) {
                dom_utils_1.setCss(children, 'display', '');
                dom_utils_1.setText(children, text);
            }
        }
    };
    Badge.prototype._setAlone = function (children) {
        if (!children.previousElementSibling) {
            children.classList.add(prefix_1.default.badge + "-count-alone");
        }
    };
    Badge.prototype._setOffset = function (parent, children) {
        var offset = this._getOffset(parent);
        dom_utils_1.setCss(children, 'marginTop', (offset === null || offset === void 0 ? void 0 : offset.x) + "px");
        dom_utils_1.setCss(children, 'marginRight', (offset === null || offset === void 0 ? void 0 : offset.y) + "px");
    };
    Badge.prototype._setStatusWithColor = function (node) {
        ...
        if (!status && !color)
            return;
        var BadgeStatusDot = dom_utils_1.createElem('span');
        var BadgeStatusText = dom_utils_1.createElem('span');
        if ((text && status) || (text && color))
            dom_utils_1.setText(BadgeStatusText, text);
        var statusCls;
        var colorCls = '';
        status ? (statusCls = prefix_1.default.badge + "-status-" + status) : (statusCls = '');
        if (color === 'blue' ||
            color === 'green' ||
            color === 'red' ||
            color === 'yellow' ||
            ...
            color === 'geekblue' ||
            color === 'purple') {
            colorCls = prefix_1.default.badge + "-status-" + color;
        }
        else {
            dom_utils_1.setCss(BadgeStatusDot, 'backgroundColor', color);
        }
        BadgeStatusDot.className = prefix_1.default.badge + "-status-dot " + statusCls + " " + colorCls;
        BadgeStatusText.className = prefix_1.default.badge + "-status-text";
    ...
    Badge.prototype._getOffset = function (node) {
        ...
        if (utils_1.type.isArr(offset) && offset.length > 0) {
            return {
                x: offset[0],
                y: offset[1]
            };
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var badge_1 = __importDefault(__webpack_require__(/*! ./badge */ "./src/components/badge/badge.ts"));
...
var Button = (function () {
    function Button() {
        this.VERSION = '1.0';
        this.components = dom_utils_1.$el("." + prefix_1.default.button, { all: true });
        this._getAllBtns(this.components);
    }
    Button.prototype.config = function (elem) {
        var target = dom_utils_1.$el(elem);
        utils_1.validComps(target, 'button');
        return {
            get loading() {
                return false;
            },
    ...
    Button.prototype._getAllBtns = function (nodes) {
        ...
        nodes.forEach(function (node) {
            ...
            _this._setIcon(node);
            dom_utils_1.removeAttrs(node, ['icon']);
        });
    };
    Button.prototype._setLoading = function (node) {
        if (this._isLoading(node)) {
            if (node.innerHTML === '')
                node.classList.add(prefix_1.default.button + "-icon-only");
            node.classList.add(prefix_1.default.button + "-loading");
    ...
    Button.prototype._setIcon = function (node) {
        ...
        if (node.innerHTML === '') {
            ...
            node.classList.add(prefix_1.default.button + "-icon-only");
            dom_utils_1.setHtml(node, btnIcon);
        }
        else {
            var Icon = dom_utils_1.createElem('i');
    ...
    Button.prototype._loadIcon = function () {
        var LoadIcon = dom_utils_1.createElem('i');
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var button_1 = __importDefault(__webpack_require__(/*! ./button */ "./src/components/button/button.ts"));
...
var Card = (function () {
    function Card() {
        this.VERSION = 'v1.0';
        this.components = dom_utils_1.$el('r-card', { all: true });
        this._create(this.components);
    }
    Card.prototype.config = function (el) {
        var target = dom_utils_1.$el(el);
        utils_1.validComps(target, 'card');
        var CardTitle = target.querySelector("." + prefix_1.default.card + "-head");
        var CardExtra = target.querySelector("." + prefix_1.default.card + "-extra");
        return {
            get title() {
                return dom_utils_1.setHtml(CardTitle);
            },
            set title(newVal) {
                if (utils_1.type.isStr(newVal))
                    dom_utils_1.setHtml(CardTitle, newVal);
            },
            get extra() {
                return dom_utils_1.setHtml(CardExtra);
            },
            set extra(newVal) {
                if (utils_1.type.isStr(newVal))
                    dom_utils_1.setHtml(CardExtra, newVal);
            }
        };
    };
    Card.prototype._create = function (nodes) {
        ...
        nodes.forEach(function (node) {
            ...
            dom_utils_1.removeAttrs(node, ['title', 'extra', 'shadow']);
        });
    };
    Card.prototype._createCardNodes = function (node) {
        var CardHead = dom_utils_1.createElem('div');
        var CardExtra = dom_utils_1.createElem('div');
        var CardBody = dom_utils_1.createElem('div');
    ...
    Card.prototype._setCls = function (node1, node2, node3) {
        node1.className = prefix_1.default.card + "-head";
        node2.className = prefix_1.default.card + "-extra";
        node3.className = prefix_1.default.card + "-body";
    };
    Card.prototype._setTitle = function (parent, children) {
        var title = this._attrs(parent).title;
        if (!title)
            return;
        dom_utils_1.setHtml(children, title);
    ...
    Card.prototype._setExtra = function (parent, children) {
        ...
        if (!extra)
            return;
        dom_utils_1.setHtml(children, extra);
        parent.appendChild(children);
    };
    Card.prototype._setShadow = function (node) {
        var shadow = this._attrs(node).shadow;
        if (shadow) {
            node.classList.add(prefix_1.default.card + "-shadow");
        }
    };
    Card.prototype._attrs = function (node) {
        return {
            title: dom_utils_1.getStrTypeAttr(node, 'title', ''),
            extra: dom_utils_1.getStrTypeAttr(node, 'extra', ''),
            shadow: dom_utils_1.getBooleanTypeAttr(node, 'shadow')
        };
    };
    return Card;
}());
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var card_1 = __importDefault(__webpack_require__(/*! ./card */ "./src/components/card/card.ts"));
...
var Divider = (function () {
    function Divider() {
        this.VERSION = 'v1.0';
        this.components = dom_utils_1.$el('r-divider', { all: true });
        this._create(this.components);
    }
    Divider.prototype._create = function (nodes) {
        ...
        nodes.forEach(function (node) {
            ...
            dom_utils_1.removeAttrs(node, ['dashed', 'plain', 'orientation']);
        });
    };
    ...
    Divider.prototype._setDashed = function (node) {
        ...
        if (dashed) {
            node.classList.add(prefix_1.default.divider + "-dashed");
        }
    };
    Divider.prototype._setPlain = function (node) {
        var plain = this._attrs(node).plain;
        if (plain) {
            node.classList.add(prefix_1.default.divider + "-plain");
        }
    };
    Divider.prototype._setOrientation = function (node) {
        var orientation = this._attrs(node).orientation;
        node.classList.add(prefix_1.default.divider + "-with-text-" + orientation);
    };
    Divider.prototype._setTitle = function (node) {
        if (node.innerHTML == '' || node.innerHTML == ' ')
            return;
        this._setOrientation(node);
        var DividerText = dom_utils_1.createElem('span');
        DividerText.className = prefix_1.default.divider + "-inner-text";
        DividerText.innerHTML = node.innerHTML;
        node.classList.add(prefix_1.default.divider + "-with-text");
        node.innerHTML = '';
        node.appendChild(DividerText);
    };
    Divider.prototype._attrs = function (node) {
        return {
            type: dom_utils_1.getStrTypeAttr(node, 'type', 'horizontal'),
            orientation: dom_utils_1.getStrTypeAttr(node, 'orientation', 'center'),
            dashed: dom_utils_1.getBooleanTypeAttr(node, 'dashed'),
            plain: dom_utils_1.getBooleanTypeAttr(node, 'plain')
        };
    };
    return Divider;
}());
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var divider_1 = __importDefault(__webpack_require__(/*! ./divider */ "./src/components/divider/divider.ts"));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var loading_bar_1 = __importDefault(__webpack_require__(/*! ./loading-bar */ "./src/components/loading-bar/loading-bar.ts"));
var Loading = new loading_bar_1.default();
...
function createLoadingBarInstance() {
    var LoadingBar = dom_utils_1.createElem('div');
    var LoadingBarInner = dom_utils_1.createElem('div');
    LoadingBar.className = "" + prefix_1.default.loadingBar;
    LoadingBarInner.className = prefix_1.default.loadingBar + "-inner";
    setColor('primary', LoadingBarInner);
    dom_utils_1.setCss(LoadingBarInner, 'width', '0%');
    setTimeout(function () {
        var height = DEFAULT_LOADINGBAR.height + "px";
        dom_utils_1.setCss(LoadingBar, 'height', height);
    }, 0);
...
function r_update(options) {
    var LBar = dom_utils_1.$el("." + prefix_1.default.loadingBar);
    var LBarInner = dom_utils_1.$el("." + prefix_1.default.loadingBar + "-inner");
    dom_utils_1.setCss(LBarInner, 'width', options.percent + "%");
    ...
    if (options.show) {
        mixins_1.CssTransition(LBarInner, __assign({ inOrOut: 'in' }, transitionConfig));
    }
    else {
        mixins_1.CssTransition(LBarInner, __assign({ inOrOut: 'out' }, transitionConfig));
    }
...
function setColor(status, elem) {
    if (status === 'error') {
        if (DEFAULT_LOADINGBAR.failedColor && DEFAULT_LOADINGBAR.failedColor !== 'error') {
            dom_utils_1.setCss(elem, 'backgroundColor', DEFAULT_LOADINGBAR.failedColor);
            setTimeout(function () {
                dom_utils_1.setCss(elem, 'backgroundColor', '');
            }, DEFAULT_LOADINGBAR.duration);
        }
        else {
            elem.classList.add(prefix_1.default.loadingBar + "-inner-failed-color-error");
            setTimeout(function () {
                elem.classList.remove(prefix_1.default.loadingBar + "-inner-failed-color-error");
            }, DEFAULT_LOADINGBAR.duration + 200);
        }
    }
    else if (status === 'primary') {
        if (DEFAULT_LOADINGBAR.color && DEFAULT_LOADINGBAR.color !== 'primary') {
            dom_utils_1.setCss(elem, 'backgroundColor', DEFAULT_LOADINGBAR.color);
        }
        else {
            elem.classList.add(prefix_1.default.loadingBar + "-inner-color-primary");
        }
    }
}
var $LoadingBar = (function () {
    function $LoadingBar() {
        this.VERSION = 'v1.0';
        this.component = dom_utils_1.$el("." + prefix_1.default.loadingBar);
    ...
    $LoadingBar.prototype.config = function (options) {
        if (options.color && utils_1.type.isStr(options.color)) {
            DEFAULT_LOADINGBAR.color = options.color;
        }
        if (options.height && utils_1.type.isNum(options.height)) {
            DEFAULT_LOADINGBAR.height = options.height;
        }
        if (options.duration && utils_1.type.isNum(options.duration)) {
            DEFAULT_LOADINGBAR.duration = options.duration;
        }
        if (options.failedColor && utils_1.type.isStr(options.failedColor)) {
            DEFAULT_LOADINGBAR.failedColor = options.failedColor;
        }
    };
    $LoadingBar.prototype.destroy = function () {
        clearTimer();
        document.body.removeChild(dom_utils_1.$el("." + prefix_1.default.loadingBar));
    };
    return $LoadingBar;
}());
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var message_1 = __importDefault(__webpack_require__(/*! ./message */ "./src/components/message/message.ts"));
...
var mixins_1 = __webpack_require__(/*! ../../mixins */ "./src/mixins/index.ts");
var utils_1 = __webpack_require__(/*! ../../utils */ "./src/utils/index.ts");
var mixins_2 = __webpack_require__(/*! ../../mixins */ "./src/mixins/index.ts");
var prefix_1 = __importDefault(__webpack_require__(/*! ../prefix */ "./src/components/prefix.ts"));
var dom_utils_1 = __webpack_require__(/*! ../../dom-utils */ "./src/dom-utils/index.ts");
var prefixKey = 'rb-message';
var MsgMoveEnter = prefix_1.default.message + "-move-enter";
var MsgMoveLeave = prefix_1.default.message + "-move-leave";
var iconTypes = {
...
function createMessageInstanceWrapper() {
    var MsgWrapper = dom_utils_1.createElem('div');
    MsgWrapper.className = "" + prefix_1.default.message;
    dom_utils_1.setCss(MsgWrapper, 'zIndex', "" + zIndex);
    setTimeout(function () {
        dom_utils_1.setCss(MsgWrapper, 'top', DEFAULT_MESSAGE.top + "px");
    }, 0);
...
var $Message = (function () {
    ...
    $Message.prototype.info = function (config) {
        ...
        return mixins_2.usePromiseCallback(DEFAULT_MESSAGE.duration, config);
    };
    ...
    $Message.prototype.config = function (options) {
        if (options.top && utils_1.type.isNum(options.top)) {
            DEFAULT_MESSAGE.top = options.top;
        }
        if ((options.duration && utils_1.type.isNum(options.duration)) || options.duration === 0) {
            DEFAULT_MESSAGE.duration = options.duration;
        }
    };
    $Message.prototype.destroy = function (key) {
        if (key && (utils_1.type.isStr(key) || utils_1.type.isNum(key))) {
            utils_1.destroyElemByKey({
                key: key,
                duration: 0.1,
                prefixKey: prefixKey,
    ...
    $Message.prototype._autoSetZindex = function () {
        zIndex++;
        dom_utils_1.setCss(dom_utils_1.$el("." + prefix_1.default.message), 'zIndex', "" + zIndex);
    };
    $Message.prototype._createInstance = function (_type, config) {
        var _a;
        this._autoSetZindex();
        var Message = dom_utils_1.createElem('div');
        var MsgContentWrap = dom_utils_1.createElem('div');
        var MsgContentBox = dom_utils_1.createElem('div');
        var MsgInfoBox = dom_utils_1.createElem('div');
        var MsgIcon = dom_utils_1.createElem('i');
        var MsgText = dom_utils_1.createElem('span');
        ...
        if (typeof config === 'object') {
            ...
            if (utils_1.type.isUndef(closable))
                closable = false;
            if (utils_1.type.isUndef(onClose))
                onClose = function () { return void 0; };
            if (utils_1.type.isUndef(background))
                background = false;
            if (utils_1.type.isUndef(duration))
        ...
        (_a = dom_utils_1.$el("." + prefix_1.default.message)) === null || _a === void 0 ? void 0 : _a.appendChild(Message);
        this.instances.push(Message);
        mixins_1.CssTransition(Message, {
            inOrOut: 'in',
    ...
    $Message.prototype._setCls = function (type, elems) {
        var nodesCls = [
            "" + prefix_1.default.messageChild,
            prefix_1.default.messageChild + "-content " + prefix_1.default.messageChild + "-content-" + type,
            prefix_1.default.messageChild + "-content-text",
            prefix_1.default.message + "-" + type,
            "" + prefix_1.default.icon
        ];
    ...
    $Message.prototype._setIcon = function (type, icon) {
        ...
        icon.classList.add(prefix_1.default.icon + "-" + iconTypes[type]);
    };
    $Message.prototype._setContent = function (node, config) {
        if (typeof config === 'string') {
            utils_1.useHTMLString(node, config, false);
        }
        else if (typeof config === 'object' && config.content) {
            utils_1.useHTMLString(node, config.content, config.dangerouslyUseHTMLString);
        }
    };
    $Message.prototype._setClosable = function (closable, parent, children, onClose) {
        if (!closable)
            return;
        parent.classList.add(prefix_1.default.messageChild + "-closable");
        var MsgCloseBtn = dom_utils_1.createElem('a');
        MsgCloseBtn.className = prefix_1.default.messageChild + "-close";
        dom_utils_1.setHtml(MsgCloseBtn, "<i class=\"" + prefix_1.default.icon + " " + prefix_1.default.icon + "-ios-close\"></i>");
    ...
    $Message.prototype._handleClose = function (parent, closeBtn, onClose) {
        closeBtn.addEventListener('click', function () {
            utils_1.type.isFn(onClose);
            utils_1.destroyElem(parent, {
                duration: 0.1,
    ...
    $Message.prototype._setBackground = function (node, children, background) {
        if (!background)
            return;
        node.classList.add(prefix_1.default.messageChild + "-with-background");
        children.classList.add(prefix_1.default.messageChild + "-content-background");
    };
    return $Message;
}());
exports.default = $Message;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var notice_1 = __importDefault(__webpack_require__(/*! ./notice */ "./src/components/notice/notice.ts"));
var Notice = new notice_1.default();
...
var NotMoveEnter = prefix_1.default.notice + "-move-enter";
var NotMoveLeave = prefix_1.default.notice + "-move-leave";
var iconTypes = {
    info: 'ios-information-circle',
    success: 'ios-checkmark-circle',
    warning: 'ios-alert',
...
function createNoticeInsanceWrapper() {
    var NoticeWrapper = dom_utils_1.createElem('div');
    NoticeWrapper.className = "" + prefix_1.default.notice;
    dom_utils_1.setCss(NoticeWrapper, 'zIndex', "" + zIndex);
    dom_utils_1.setCss(NoticeWrapper, 'right', '0');
    setTimeout(function () { return dom_utils_1.setCss(NoticeWrapper, 'top', DEFAULT_NOTICE.top + "px"); }, 0);
...
var $Notice = (function () {
    ...
    $Notice.prototype.open = function (config) {
        ...
        return mixins_2.usePromiseCallback(DEFAULT_NOTICE.duration, config.duration);
    };
    ...
    $Notice.prototype._autoSetZindex = function () {
        zIndex++;
        dom_utils_1.setCss(dom_utils_1.$el("." + prefix_1.default.notice), 'zIndex', "" + zIndex);
    };
    $Notice.prototype._createInstance = function (type, config) {
        var _a;
        this._autoSetZindex();
        var Notice = dom_utils_1.createElem('div');
        var NoticeContent = dom_utils_1.createElem('div');
        var NoticeCustomContent = dom_utils_1.createElem('div');
        var NoticeTitle = dom_utils_1.createElem('div');
        var NoticeDesc = dom_utils_1.createElem('div');
        ...
        (_a = document.querySelector("." + prefix_1.default.notice)) === null || _a === void 0 ? void 0 : _a.appendChild(Notice);
        mixins_1.CssTransition(Notice, {
            inOrOut: 'in',
    ...
    $Notice.prototype._setCls = function (type, nodes, customCls) {
        var nodesCls = [
            prefix_1.default.noticeChild + " " + (customCls ? customCls : ''),
            prefix_1.default.noticeChild + "-content",
            prefix_1.default.noticeChild + "-custom-content " + prefix_1.default.notice + "-with-" + type,
            prefix_1.default.notice + "-title",
            prefix_1.default.notice + "-desc"
        ];
        var i = 0;
    ...
    $Notice.prototype._setTitle = function (node, title, dangerouslyUseHTMLString) {
        if (!title) {
            mixins_1.warn('You must set a notification to remind the title');
            return;
        }
        utils_1.useHTMLString(node, title, dangerouslyUseHTMLString);
    };
    $Notice.prototype._setDesc = function (parent, children_custm, child_desc, desc, dangerouslyUseHTMLString) {
        if (!desc)
            return;
        parent.classList.add(prefix_1.default.noticeChild + "-with-desc");
        children_custm.classList.add(prefix_1.default.notice + "-with-desc");
        utils_1.useHTMLString(child_desc, desc, dangerouslyUseHTMLString);
    };
    $Notice.prototype._setIcon = function (type, child_custom, child_desc, customIcon) {
        if (type === 'noraml')
            return;
        if (type !== 'normal' || customIcon) {
            child_custom.classList.add(prefix_1.default.notice + "-with-icon");
        }
        var isOutline = '';
        if (child_desc.innerHTML)
            isOutline = '-outline';
        var NoticeIcon = dom_utils_1.createElem('span');
        NoticeIcon.className = prefix_1.default.notice + "-icon " + prefix_1.default.notice + "-icon-" + type;
        if (customIcon) {
            dom_utils_1.setHtml(NoticeIcon, customIcon);
        }
        else {
            var defaultIcon = "<i class=\"" + prefix_1.default.icon + " " + prefix_1.default.icon + "-" + iconTypes[type] + isOutline + "\"></i>";
            dom_utils_1.setHtml(NoticeIcon, defaultIcon);
        }
        child_custom.prepend(NoticeIcon);
    };
    $Notice.prototype._setClosable = function (parent, closable, onClose) {
        utils_1.type.isUndef(closable) ? (closable = true) : closable;
        if (!closable)
            return;
        parent.classList.add(prefix_1.default.noticeChild + "-closable");
        var NoticeClose = dom_utils_1.createElem('a');
        var closeIcon = "<i class=\"" + prefix_1.default.icon + " " + prefix_1.default.icon + "-ios-close\"></i>";
        NoticeClose.className = prefix_1.default.noticeChild + "-close";
        dom_utils_1.setHtml(NoticeClose, closeIcon);
    ...
    $Notice.prototype._autoClose = function (instance, duration) {
        utils_1.type.isUndef(duration) ? (duration = DEFAULT_NOTICE.duration) : duration;
        utils_1.destroyElem(instance, {
            duration: duration,
            clsLeave: NotMoveLeave,
            transitionTime: 0.5
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var poptip_1 = __importDefault(__webpack_require__(/*! ./poptip */ "./src/components/poptip/poptip.ts"));
exports.default = poptip_1.default;
...
var prefix_1 = __importDefault(__webpack_require__(/*! ../prefix */ "./src/components/prefix.ts"));
var dom_utils_1 = __webpack_require__(/*! ../../dom-utils */ "./src/dom-utils/index.ts");
var tooltip_1 = __webpack_require__(/*! ../../mixins/tooltip */ "./src/mixins/tooltip.ts");
var mixins_1 = __webpack_require__(/*! ../../mixins */ "./src/mixins/index.ts");
var utils_1 = __webpack_require__(/*! ../../utils */ "./src/utils/index.ts");
...
var Poptip = (function () {
    function Poptip() {
        this.VERSION = 'v1.0';
        this.components = dom_utils_1.$el('r-poptip', { all: true });
        this._create(this.components);
        this.children = dom_utils_1.$el('.rab-poptip-popper', { all: true });
        mixins_1.clickOutside(this.children, 'poptipShow', 'zoom-big-fast-leave');
        mixins_1._arrow.scrollUpdate();
    }
    Poptip.prototype.config = function (el) {
        var target = dom_utils_1.$el(el);
        utils_1.validComps(target, 'poptip');
        var attrs = Poptip.prototype.attrs;
        var PoptipRef = target.querySelector("." + prefix_1.default.poptip + "-rel");
        var PoptipPopper = target.querySelector("." + prefix_1.default.poptip + "-popper");
        var PoptipContent = target.querySelector("." + prefix_1.default.poptip + "-body-content-inner");
        var PoptipTitle;
        var OkBtn;
        var CancelBtn;
        if (attrs(target).isConfirm) {
            PoptipTitle = target.querySelector("." + prefix_1.default.poptip + "-body-message");
            OkBtn = target.querySelector("." + prefix_1.default.button + "-primary." + prefix_1.default.button + "-sm");
            CancelBtn = target.querySelector("." + prefix_1.default.button + "-text." + prefix_1.default.button + "-sm");
        }
        else {
            PoptipTitle = target.querySelector("." + prefix_1.default.poptip + "-title-inner");
        }
        return {
            get title() {
                return dom_utils_1.setHtml(PoptipTitle);
            },
            set title(newVal) {
                if (utils_1.type.isStr(newVal) || utils_1.type.isNum(newVal))
                    dom_utils_1.setHtml(PoptipTitle, newVal);
            },
            get content() {
                return dom_utils_1.setHtml(PoptipContent);
            },
            set content(newVal) {
                if (utils_1.type.isStr(newVal) || utils_1.type.isNum(newVal))
                    dom_utils_1.setHtml(PoptipContent, newVal);
            },
            events: function (_a) {
                ...
                var showEv = function () {
                    if (PoptipPopper.dataset.poptipShow === 'true')
                        onShow && utils_1.type.isFn(onShow);
                };
                var hideEv = function () {
                    if (PoptipPopper.dataset.poptipShow === 'false')
                        onHide && utils_1.type.isFn(onHide);
                };
                ...
                if (triggerMode === 'click') {
                    ...
                    mixins_1._Popper.handleHoverShowAndHideEvents({
                        reference: target,
                        popper: PoptipPopper,
                ...
                if (OkBtn) {
                    OkBtn.addEventListener('click', function () {
                        hideEv();
                        onOk && utils_1.type.isFn(onOk);
                    });
                }
                if (CancelBtn) {
                    CancelBtn.addEventListener('click', function () {
                        hideEv();
                        onCancel && utils_1.type.isFn(onCancel);
                    });
                }
            }
        };
    ...
    Poptip.prototype._createPoptipNodes = function (node, i) {
        ...
        if (attrs.isConfirm)
            node.className = prefix_1.default.poptip + "-confirm";
        var uid = "poptip" + i;
        var referenceElem = node.firstElementChild;
        var PoptipRel = dom_utils_1.createElem('div');
        PoptipRel.className = prefix_1.default.poptip + "-rel";
        PoptipRel.appendChild(referenceElem);
        var whatModel = attrs.isConfirm ? this._confirmTpl(attrs) : this._normalTpl(attrs);
        var template = "\n            <div class=\"" + prefix_1.default.poptip + "-popper\" x-placement=" + attrs.placement + " data-poptip-uid=" + uid + ">\n                <div class=\"" + prefix_1.default.poptip + "-content\">\n                    <div class=\"" + prefix_1.default.poptip + "-arrow\" data-popper-arrow></div>\n                    <div class=\"" + prefix_1.default.poptip + "-inner\">" + whatModel + "</div>\n                </div>\n            </div>\n        ";
        dom_utils_1.setHtml(node, template);
        this._setWidth(attrs, uid);
        var Popper = dom_utils_1.$el("[data-poptip-uid=" + uid + "]");
        Popper === null || Popper === void 0 ? void 0 : Popper.before(PoptipRel);
        dom_utils_1.setCss(Popper, 'display', 'none');
        if (!attrs.isDisabled) {
    ...
    Poptip.prototype._normalTpl = function (attrs) {
        ...
        var isShowTitle = !attrs.isWordWrap && attrs.title
            ? "<div class=\"" + prefix_1.default.poptip + "-title\" style=\"" + setPadding + "\">\n                      <div class=\"" + prefix_1.default.poptip + "-title-inner\">" + attrs.title + "</div>\n                   </div>"
            : '';
        var template = "\n            " + isShowTitle + "\n            <div class=\"" + prefix_1.default.poptip + "-body\" style=\"" + setPadding + "\">\n                <div class=\"" + prefix_1.default.poptip + "-body-content\">\n                <div class=\"" + prefix_1.default.poptip + "-body-content-inner\">" + attrs.content + "</div>\n                </div>\n            </div>\n            ";
        return template;
    };
    Poptip.prototype._confirmTpl = function (attrs) {
        var template = "\n          <div class=\"" + prefix_1.default.poptip + "-body\">\n              <i class=\"" + prefix_1.default.icon + " " + prefix_1.default.icon + "-ios-help-circle\"></i>\n              <div class=\"" + prefix_1.default.poptip + "-body-message\">" + attrs.title + "</div>\n          </div>\n          <div class=\"" + prefix_1.default.poptip + "-footer\">\n              <button class=\"" + prefix_1.default.button + " " + prefix_1.default.button + "-text " + prefix_1.default.button + "-sm\">" + attrs.cancelText + "</button>\n              <button class=\"" + prefix_1.default.button + " " + prefix_1.default.button + "-primary " + prefix_1.default.button + "-sm\">" + attrs.okText + "</button>\n          </div>\n      ";
        return template;
    };
    Poptip.prototype._setWidth = function (attrs, uid) {
        var popper = document.querySelector("[data-poptip-uid=" + uid + "]");
        if (attrs.width) {
            dom_utils_1.setCss(popper, 'width', attrs.width + "px");
        }
        if (attrs.isWordWrap) {
            var popperContent = popper === null || popper === void 0 ? void 0 : popper.querySelector("." + prefix_1.default.poptip + "-body-content");
            popperContent === null || popperContent === void 0 ? void 0 : popperContent.classList.add(prefix_1.default.poptip + "-body-content-word-wrap");
        }
    };
    Poptip.prototype._triggerDisplay = function (trigger, parent, referenceChild, popper, poptipAttrs) {
        if (trigger !== 'click' && trigger !== 'hover' && trigger !== 'focus') {
            mixins_1.warn("The Poptip attribute trigger got an invalid trigger mode --> '" + trigger + "'");
            return;
        }
        ...
        if (trigger === 'click') {
            ...
            mixins_1._arrow.toggleUpdate(popper, 'hover', parent, defalutPoptipDelay);
        }
        if (poptipAttrs.isConfirm) {
            var confirmOkBtn = popper.querySelector("." + prefix_1.default.button + "-primary." + prefix_1.default.button + "-sm");
            var confirmCancelBtn = popper.querySelector("." + prefix_1.default.button + "-text." + prefix_1.default.button + "-sm");
    ...
    Poptip.prototype._initPoptip = function (reference, popper, poptipAttrs) {
        var NCP = tooltip_1._newCreatePopper(reference, popper, poptipAttrs.placement, poptipAttrs.offset);
        return NCP;
    };
    Poptip.prototype.attrs = function (node) {
        return {
            width: dom_utils_1.getNumTypeAttr(node, 'width', 0),
            offset: dom_utils_1.getNumTypeAttr(node, 'offset', 0),
            title: dom_utils_1.getStrTypeAttr(node, 'title', ''),
            okText: dom_utils_1.getStrTypeAttr(node, 'ok-text', '确定'),
            content: dom_utils_1.getStrTypeAttr(node, 'content', ''),
            trigger: dom_utils_1.getStrTypeAttr(node, 'trigger', 'click'),
            padding: dom_utils_1.getStrTypeAttr(node, 'padding', ''),
            placement: dom_utils_1.getStrTypeAttr(node, 'placement', 'top'),
            cancelText: dom_utils_1.getStrTypeAttr(node, 'cancel-text', '取消'),
            isConfirm: dom_utils_1.getBooleanTypeAttr(node, 'confirm'),
            isDisabled: dom_utils_1.getBooleanTypeAttr(node, 'disabled'),
            isWordWrap: dom_utils_1.getBooleanTypeAttr(node, 'word-wrap')
        };
    };
    return Poptip;
}());
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var progress_1 = __importDefault(__webpack_require__(/*! ./progress */ "./src/components/progress/progress.ts"));
...
var Progress = (function () {
    function Progress() {
        this.VERSION = 'v1.0';
        this.components = dom_utils_1.$el('r-progress', { all: true });
        this._create(this.components);
    }
    Progress.prototype.config = function (el) {
        var target = dom_utils_1.$el(el);
        utils_1.validComps(target, 'progress');
        var progress = target.querySelector("." + prefix_1.default.progress + "-bg");
        var progressSucs = target.querySelector("." + prefix_1.default.progress + "-success-bg");
        var progressText = target.querySelector("." + prefix_1.default.progress + "-inner-text");
        return {
            get percent() {
                return progress;
            },
            set percent(newVal) {
                if (!utils_1.type.isNum(newVal) || newVal == progress.style.width)
                    return;
                if (progressText)
                    dom_utils_1.setHtml(progressText, newVal + "%");
                dom_utils_1.setCss(progress, 'width', newVal + "%");
            },
            get successPercent() {
                return progressSucs;
            },
            set successPercent(newVal) {
                if (!utils_1.type.isNum(newVal) || newVal == progressSucs.style.width)
                    return;
                dom_utils_1.setCss(progressSucs, 'width', newVal + "%");
            }
        };
    };
    ...
    Progress.prototype._createChildNodes = function (wrapper) {
        var PgrsOuter = dom_utils_1.createElem('div');
        var PgrsInner = dom_utils_1.createElem('div');
        var PgrsBar = dom_utils_1.createElem('div');
        var PgrsBarSucess = dom_utils_1.createElem('div');
        PgrsOuter.className = prefix_1.default.progress + "-outer";
        PgrsInner.className = prefix_1.default.progress + "-inner";
        PgrsBar.className = prefix_1.default.progress + "-bg";
        PgrsBarSucess.className = prefix_1.default.progress + "-success-bg";
    ...
    Progress.prototype._setPercent = function (wrapper, bar, successBar) {
        ...
        dom_utils_1.setCss(bar, 'width', percent);
        dom_utils_1.setCss(successBar, 'width', successPercent);
    };
    Progress.prototype._setStrokeWidth = function (wrapper, bar, successBar) {
        var strokeWidth = this._getStrokeWidth(wrapper) + "px";
        dom_utils_1.setCss(bar, 'height', strokeWidth);
        dom_utils_1.setCss(successBar, 'height', strokeWidth);
    };
    Progress.prototype._showText = function (wrapper, PgrsBar) {
        if (!this._isShowText(wrapper))
            return;
        var PgrsTextWrapper = dom_utils_1.createElem('div');
        var PgresText = dom_utils_1.createElem('span');
        PgrsTextWrapper.className = prefix_1.default.progress + "-text";
        PgresText.className = prefix_1.default.progress + "-inner-text";
        var percentText = this._getPercent(wrapper) + "%";
        dom_utils_1.setText(PgresText, percentText);
        if (!this._isTextInside(wrapper)) {
            wrapper.className = prefix_1.default.progress + "-show-info";
            if (this._getStatus(wrapper) === 'success') {
                dom_utils_1.setHtml(PgresText, PrgesIconType.success);
            }
            else if (this._getStatus(wrapper) === 'warning') {
                dom_utils_1.setHtml(PgresText, PrgesIconType.warning);
            }
            else if (this._getStatus(wrapper) === 'wrong') {
                dom_utils_1.setHtml(PgresText, PrgesIconType.wrong);
            }
    ...
    Progress.prototype._setStrokeColor = function (wrapper, PgrsBar) {
        ...
        if (from.length || to.length) {
            ...
            dom_utils_1.setCss(PgrsBar, 'backgroundImage', strokeColor);
        }
    };
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var steps_1 = __importDefault(__webpack_require__(/*! ./steps */ "./src/components/steps/steps.ts"));
...
var Steps = (function () {
    function Steps() {
        this.VERSION = '1.0';
        this.components = dom_utils_1.$el('r-steps', { all: true });
        this._create(this.components);
    }
    Steps.prototype.config = function (el) {
        var target = dom_utils_1.$el(el);
        utils_1.validComps(target, 'steps');
        ...
        return {
            setSteps: function (_a) {
                ...
                if (current !== oldCurrent) {
                    if (!current && current !== 0) {
                        mixins_1.warn('The current property is missing in the Steps configuration');
                        return;
                    }
                    else if ((current && utils_1.type.isNum(current)) || (status && utils_1.type.isStr(status))) {
            ...
            setChildren: function (_a) {
                ...
                var ChildTitle = ChildCurrent.querySelector("." + prefix_1.default.steps + "-title");
                var ChildContent = ChildCurrent.querySelector("." + prefix_1.default.steps + "-content");
                if (title && utils_1.type.isStr(title))
                    dom_utils_1.setText(ChildTitle, title);
                if (content && utils_1.type.isStr(content))
                    dom_utils_1.setText(ChildContent, content);
            }
        };
    };
    Steps.prototype._create = function (nodes) {
        ...
        nodes.forEach(function (node) {
            ...
            dom_utils_1.removeAttrs(node, ['status']);
        });
    };
    Steps.prototype._createStepItem = function (node) {
        ...
        for (; i < length; i++) {
            ...
            child.innerHTML = "\n             <div class=\"" + prefix_1.default.steps + "-tail\"><i></i></div>\n             <div class=\"" + prefix_1.default.steps + "-head\">\n                 <div class=\"" + prefix_1.default.steps + "-head-inner\">\n                    <span data-steps-uid=" + uid + " data-step=\"current\">" + idxText + "</span>\n                 </div>\n             </div>\n             <div class=\"" + prefix_1.default.steps + "-main\">\n                 <div class=\"" + prefix_1.default.steps + "-title\">" + title + "</div>\n                 <div class=\"" + prefix_1.default.steps + "-content\">" + content + "</div>\n             </div>\n            ";
            this._setCustomIcon(child);
            this._setNextErrorStatus(child);
            this._autoSetFinishOrErrorIcon(child, i);
            dom_utils_1.removeAttrs(child, ['title', 'content', 'icon']);
        }
    };
    ...
    Steps.prototype._updateStatus = function (parent, current, status) {
        ...
        utils_1.validComps(currentStep, 'step');
    ...
    Steps.prototype._setPrevStatus = function (node) {
        var _this_1 = this;
        dom_utils_1.prevAll(node).forEach(function (prevNode) {
    ...
    Steps.prototype._setNextStatus = function (node) {
        var _this_1 = this;
        dom_utils_1.nextAll(node).forEach(function (nextNode) { return _this_1._setCurrentStatus(nextNode); });
    };
    Steps.prototype._setNextErrorStatus = function (node) {
        if (this._geStatus(node) === 'error' &&
            ...
            node.previousElementSibling.classList.add(prefix_1.default.steps + "-next-error");
        }
    };
    Steps.prototype._autoSetFinishOrErrorIcon = function (node, current) {
        ...
        if (this._getIcon(node))
            return;
        var prefixIconCls = prefix_1.default.steps + "-icon " + prefix_1.default.icon + " " + prefix_1.default.icon + "-";
    ...
    Steps.prototype._setCustomIcon = function (node) {
        ...
        if (!iconType)
            return;
        node.classList.add(prefix_1.default.steps + "-custom");
        var child = node.querySelector("." + prefix_1.default.steps + "-head-inner").children[0];
        dom_utils_1.setHtml(child, '');
        child.className = prefix_1.default.steps + "-icon " + prefix_1.default.icon + " " + prefix_1.default.icon + "-" + iconType;
    };
    ...
    Steps.prototype._validIndexCheck = function (total, current, inode) {
        if (!inode) {
            mixins_1.warn("The current total number of steps is only " + total + ", you cannot set it to " + current);
            return;
        }
    };
    return Steps;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var switch_1 = __importDefault(__webpack_require__(/*! ./switch */ "./src/components/switch/switch.ts"));
...
var Switch = (function () {
    ...
    Switch.prototype._setStatusText = function (node, status) {
        ...
        TextBox.className = prefix_1.default.switch + "-inner";
        node.appendChild(TextBox);
        status ? dom_utils_1.setHtml(TextBox, openText) : dom_utils_1.setHtml(TextBox, closeText);
    };
    Switch.prototype._setStatusColor = function (node, status) {
        ...
        if (!trueColor || !falseColor)
            return;
        if (status) {
            dom_utils_1.setCss(node, 'borderColor', trueColor);
            dom_utils_1.setCss(node, 'backgroundColor', trueColor);
        }
        else {
            dom_utils_1.setCss(node, 'borderColor', falseColor);
            dom_utils_1.setCss(node, 'backgroundColor', falseColor);
        }
    };
    ...
    Switch.prototype._changeStatusText = function (node, status, openText, closeText) {
        var TextBox = node.querySelector("." + prefix_1.default.switch + "-inner");
        if (TextBox) {
            status ? dom_utils_1.setHtml(TextBox, openText) : dom_utils_1.setHtml(TextBox, closeText);
        }
    };
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var time_1 = __importDefault(__webpack_require__(/*! ./time */ "./src/components/time/time.ts"));
exports.default = time_1.default;
...
var Time = (function () {
    function Time() {
        this.VERSION = 'v1.0';
        this.components = dom_utils_1.$el('r-time', { all: true });
        this._create(this.components);
    }
    Time.prototype._create = function (nodes) {
        ...
        nodes.forEach(function (node) {
            ...
            dom_utils_1.removeAttrs(node, ['time', 'type', 'hash', 'locale', 'interval']);
        });
    };
    Time.prototype.setTime = function (node) {
        ...
        var timer = function () {
            if (type === 'relative') {
                var relativeTime = moment_1.default(timeStamp).locale(locale).fromNow();
                if (relativeTime === '几秒前') {
                    relativeTime = '刚刚';
                    if (interval < 60) {
                        dom_utils_1.setText(node, moment_1.default().startOf('second').format('s') + "\u79D2\u524D");
                    }
                    else {
                        dom_utils_1.setText(node, relativeTime);
                    }
                }
                else {
                    dom_utils_1.setText(node, relativeTime);
                ...
                var data = moment_1.default(timeStamp).format('YYYY-MM-DD');
                dom_utils_1.setText(node, data);
            }
            else if (type === 'datetime') {
                var dataTime = moment_1.default(timeStamp).format('YYYY-MM-DD-HH:mm:ss');
                dom_utils_1.setText(node, dataTime);
            }
            return timer;
        };
    ...
    Time.prototype.handleClick = function (node) {
        ...
        if (!hash)
            return;
        node.classList.add(prefix_1.default.time + "-with-hash");
        node.addEventListener('click', function () { return (window.location.hash = hash); });
    };
    Time.prototype._attrs = function (node) {
        return {
            time: dom_utils_1.getStrTypeAttr(node, 'time', ''),
            type: dom_utils_1.getStrTypeAttr(node, 'type', 'relative'),
            hash: dom_utils_1.getStrTypeAttr(node, 'hash', ''),
            locale: dom_utils_1.getStrTypeAttr(node, 'locale', 'zh-cn'),
            interval: dom_utils_1.getNumTypeAttr(node, 'interval', 60)
        };
    };
    return Time;
}());
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var timeline_1 = __importDefault(__webpack_require__(/*! ./timeline */ "./src/components/timeline/timeline.ts"));
...
var Timeline = (function () {
    function Timeline() {
        this.VERSION = '1.0';
        this.components = dom_utils_1.$el('r-timeline > r-timeline-item', { all: true });
        this._create(this.components);
    }
    Timeline.prototype._create = function (nodes) {
        ...
        nodes.forEach(function (node) {
            ...
            var TimelineTail = dom_utils_1.createElem('div');
            var TimelineHead = dom_utils_1.createElem('div');
            var TimelineContent = dom_utils_1.createElem('div');
            ...
            dom_utils_1.removeAttrs(TimelineItem, ['dot']);
        });
    };
    Timeline.prototype._setCls = function (node1, node2, node3) {
        node1.className = prefix_1.default.timeline + "-item-tail";
        node2.className = prefix_1.default.timeline + "-item-head";
        node3.className = prefix_1.default.timeline + "-item-content";
    };
    Timeline.prototype._setContent = function (parent, node1) {
        dom_utils_1.setHtml(node1, parent.innerHTML);
        dom_utils_1.setHtml(parent, '');
    };
    Timeline.prototype._setColor = function (parent, node) {
        ...
        if (colors === 'blue' || colors === 'red' || colors === 'gray' || colors === 'green') {
            node.classList.add(prefix_1.default.timeline + "-item-head-" + colors);
        }
        else {
            dom_utils_1.setCss(node, 'color', colors);
            dom_utils_1.setCss(node, 'borderColor', colors);
        }
    };
    Timeline.prototype._setDot = function (parent, node) {
        if (!this._getDotContent(parent))
            return;
        node.classList.add(prefix_1.default.timeline + "-item-head-custom");
        var content = this._getDotContent(parent);
        dom_utils_1.setHtml(node, content);
    };
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var tooltip_1 = __importDefault(__webpack_require__(/*! ./tooltip */ "./src/components/tooltip/tooltip.ts"));
...
var Tooltip = (function () {
    function Tooltip() {
        this.VERSION = 'v1.0';
        this.components = dom_utils_1.$el('r-tooltip', { all: true });
        this._create(this.components);
        mixins_1._arrow.scrollUpdate();
    }
    Tooltip.prototype.config = function (el) {
        var target = dom_utils_1.$el(el);
        utils_1.validComps(target, 'tooltip');
        var _a = Tooltip.prototype, _getDelay = _a._getDelay, _getIsAlways = _a._getIsAlways, _getIsDisabled = _a._getIsDisabled;
        var popper = target.querySelector("." + prefix_1.default.tooltip + "-popper");
        var popperText = target.querySelector("." + prefix_1.default.tooltip + "-inner");
        return {
            get content() {
                return dom_utils_1.setText(popperText);
            },
            set content(newVal) {
                if (utils_1.type.isStr(newVal) || utils_1.type.isNum(newVal))
                    dom_utils_1.setHtml(popperText, "" + newVal);
            },
            events: function (_a) {
    ...
    Tooltip.prototype._create = function (nodes) {
        ...
        nodes.forEach(function (node) {
            ...
            dom_utils_1.removeAttrs(node, ['content', 'theme', 'delay', 'max-width', 'disabled', 'always']);
        });
    };
    Tooltip.prototype._createTooltipNodes = function (reference) {
        var TooltipRef = dom_utils_1.createElem('div');
        var TooltipPopper = dom_utils_1.createElem('div');
        var TooltipContent = dom_utils_1.createElem('div');
        var TooltipArrow = dom_utils_1.createElem('div');
        var TooltipInner = dom_utils_1.createElem('div');
    ...
    Tooltip.prototype._setCls = function (reference, nodes) {
        ...
        var nodesCls = [
            prefix_1.default.tooltip + "-rel",
            prefix_1.default.tooltip + "-popper " + prefix_1.default.tooltip + "-" + theme,
            prefix_1.default.tooltip + "-content",
            prefix_1.default.tooltip + "-arrow",
            prefix_1.default.tooltip + "-inner"
        ];
        var i = 0;
        var length = nodes.length;
        for (; i < length; i++) {
    ...
    Tooltip.prototype._triggerDisplay = function (trigger, reference, popper) {
        ...
        if (trigger === 'enter') {
            ...
            mixins_1._arrow.toggleUpdate(popper, 'hover', reference, delay);
        }
        else {
    ...
    Tooltip.prototype._setMaxWidth = function (reference, popper) {
        ...
        if (maxWidth <= 0)
            return;
        dom_utils_1.setCss(popper, 'maxWidth', maxWidth + "px");
        popper.classList.add(prefix_1.default.tooltip + "-inner-with-width");
    };
    Tooltip.prototype._initSetPopper = function (reference, popper) {
        ...
        return mixins_1._Popper._newCreatePopper(reference, popper, placement, offset);
    };
    Tooltip.prototype._setIsAlwaysShow = function (reference, popper) {
        var isAlways = this._getIsAlways(reference);
        if (isAlways) {
            dom_utils_1.setCss(popper, 'display', '');
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getArrTypeAttr = exports.getNumTypeAttr = exports.getBooleanTypeAttr = exports.getStrTypeAttr = exports.setText = exports.setHtml = exports.setCss = exports.createElem = exports.$el = void 0;
...
exports.getArrTypeAttr = getArrTypeAttr;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getBooleanTypeAttr = exports.getNumTypeAttr = exports.getStrTypeAttr = exports.slide = exports.siblings = exports.removeAttrs = exports.nextAll = exports.prevAll = exports.setText = exports.setHtml = exports.setCss = exports.createElem = exports.$el = void 0;
var elem_1 = __webpack_require__(/*! ./elem */ "./src/dom-utils/elem.ts");
Object.defineProperty(exports, "$el", ({ enumerable: true, get: function () { return elem_1.$el; } }));
Object.defineProperty(exports, "createElem", ({ enumerable: true, get: function () { return elem_1.createElem; } }));
Object.defineProperty(exports, "setCss", ({ enumerable: true, get: function () { return elem_1.setCss; } }));
Object.defineProperty(exports, "setHtml", ({ enumerable: true, get: function () { return elem_1.setHtml; } }));
Object.defineProperty(exports, "setText", ({ enumerable: true, get: function () { return elem_1.setText; } }));
Object.defineProperty(exports, "getStrTypeAttr", ({ enumerable: true, get: function () { return elem_1.getStrTypeAttr; } }));
Object.defineProperty(exports, "getNumTypeAttr", ({ enumerable: true, get: function () { return elem_1.getNumTypeAttr; } }));
Object.defineProperty(exports, "getBooleanTypeAttr", ({ enumerable: true, get: function () { return elem_1.getBooleanTypeAttr; } }));
var prev_next_1 = __webpack_require__(/*! ./prev&next */ "./src/dom-utils/prev&next.ts");
Object.defineProperty(exports, "prevAll", ({ enumerable: true, get: function () { return prev_next_1.prevAll; } }));
Object.defineProperty(exports, "nextAll", ({ enumerable: true, get: function () { return prev_next_1.nextAll; } }));
var remove_attrs_1 = __importDefault(__webpack_require__(/*! ./remove-attrs */ "./src/dom-utils/remove-attrs.ts"));
exports.removeAttrs = remove_attrs_1.default;
var siblings_1 = __importDefault(__webpack_require__(/*! ./siblings */ "./src/dom-utils/siblings.ts"));
exports.siblings = siblings_1.default;
var slide_1 = __importDefault(__webpack_require__(/*! ./slide */ "./src/dom-utils/slide.ts"));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.nextAll = exports.prevAll = void 0;
function prevAll(el) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var alert_1 = __importDefault(__webpack_require__(/*! ./components/alert */ "./src/components/alert/index.ts"));
var avatar_1 = __importDefault(__webpack_require__(/*! ./components/avatar */ "./src/components/avatar/index.ts"));
var badge_1 = __importDefault(__webpack_require__(/*! ./components/badge */ "./src/components/badge/index.ts"));
var button_1 = __importDefault(__webpack_require__(/*! ./components/button */ "./src/components/button/index.ts"));
var card_1 = __importDefault(__webpack_require__(/*! ./components/card */ "./src/components/card/index.ts"));
var divider_1 = __importDefault(__webpack_require__(/*! ./components/divider */ "./src/components/divider/index.ts"));
var loading_bar_1 = __importDefault(__webpack_require__(/*! ./components/loading-bar */ "./src/components/loading-bar/index.ts"));
var message_1 = __importDefault(__webpack_require__(/*! ./components/message */ "./src/components/message/index.ts"));
var notice_1 = __importDefault(__webpack_require__(/*! ./components/notice */ "./src/components/notice/index.ts"));
var poptip_1 = __importDefault(__webpack_require__(/*! ./components/poptip */ "./src/components/poptip/index.ts"));
var progress_1 = __importDefault(__webpack_require__(/*! ./components/progress */ "./src/components/progress/index.ts"));
var steps_1 = __importDefault(__webpack_require__(/*! ./components/steps */ "./src/components/steps/index.ts"));
var switch_1 = __importDefault(__webpack_require__(/*! ./components/switch */ "./src/components/switch/index.ts"));
var time_1 = __importDefault(__webpack_require__(/*! ./components/time */ "./src/components/time/index.ts"));
var timeline_1 = __importDefault(__webpack_require__(/*! ./components/timeline */ "./src/components/timeline/index.ts"));
var tooltip_1 = __importDefault(__webpack_require__(/*! ./components/tooltip */ "./src/components/tooltip/index.ts"));
...
var Rabbit = {
    ...
    Loading: loading_bar_1.default,
    Message: message_1.default,
    Notice: notice_1.default,
    Poptip: poptip_1.default,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.toggleUpdate = exports.scrollUpdate = void 0;
var dom_utils_1 = __webpack_require__(/*! ../dom-utils */ "./src/dom-utils/index.ts");
function scrollUpdate() {
    var tooltips = dom_utils_1.$el('.rab-tooltip-popper', { all: true });
    var poptips = dom_utils_1.$el('.rab-poptip-popper', { all: true });
...
exports.default = usePromiseCallback;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var _1 = __webpack_require__(/*! . */ "./src/mixins/index.ts");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports._Popper = exports.clickOutside = exports.usePromiseCallback = exports.CssTransition = exports._arrow = exports.warn = void 0;
var warn_1 = __importDefault(__webpack_require__(/*! ./warn */ "./src/mixins/warn.ts"));
exports.warn = warn_1.default;
var _arrow = __importStar(__webpack_require__(/*! ./arrow */ "./src/mixins/arrow.ts"));
exports._arrow = _arrow;
var css_transition_1 = __importDefault(__webpack_require__(/*! ./css-transition */ "./src/mixins/css-transition.ts"));
exports.CssTransition = css_transition_1.default;
var cb_promise_1 = __importDefault(__webpack_require__(/*! ./cb-promise */ "./src/mixins/cb-promise.ts"));
exports.usePromiseCallback = cb_promise_1.default;
var click_outside_1 = __importDefault(__webpack_require__(/*! ./click-outside */ "./src/mixins/click-outside.ts"));
exports.clickOutside = click_outside_1.default;
var _Popper = __importStar(__webpack_require__(/*! ./tooltip */ "./src/mixins/tooltip.ts"));
exports._Popper = _Popper;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.handleHoverShowAndHideEvents = exports._newCreatePopper = void 0;
...
function _newCreatePopper(reference, popper, placement, offset) {
    return core_1.createPopper(reference, popper, {
        placement: placement,
        modifiers: [
            {
                name: 'computeStyles',
...
exports._newCreatePopper = _newCreatePopper;
function handleHoverShowAndHideEvents(_a) {
    ...
    function showEv() {
        ...
        showCb && utils_1.type.isFn(showCb);
    }
    function hideEv() {
        clearTimeout(timer);
        if (popper.dataset[datasetVal] === 'show') {
            popper.dataset[datasetVal] = 'hide';
            hideCb && utils_1.type.isFn(hideCb);
        }
        reference.removeEventListener('mouseenter', showEv);
    }
}
exports.handleHoverShowAndHideEvents = handleHoverShowAndHideEvents;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isArr = exports.isObj = exports.isFn = exports.isBol = exports.isNum = exports.isStr = exports.isUndef = void 0;
var warn_1 = __importDefault(__webpack_require__(/*! ../mixins/warn */ "./src/mixins/warn.ts"));
var typeOf = function (r) {
    var s = Object.prototype.toString.call(r);
    return s.match(/\[object (.*?)\]/)[1].toLowerCase();
};
var errMsg = function (right, wrong) {
    warn_1.default("The expected type accepted is " + right + ", but the error type currently in use is --> " + wrong);
    return false;
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.destroyElemByKey = exports.destroyElem = void 0;
var mixins_1 = __webpack_require__(/*! ../mixins */ "./src/mixins/index.ts");
...
exports.destroyElem = destroyElem;
function destroyElemByKey(options) {
    ...
    target ? destroyElem(target, options) : mixins_1.warn("The key value is invalid --> \"" + key + "\"");
}
exports.destroyElemByKey = destroyElemByKey;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.validComps = exports.useHTMLString = exports.destroyElemByKey = exports.destroyElem = exports.type = void 0;
var type = __importStar(__webpack_require__(/*! ./check-type */ "./src/utils/check-type.ts"));
exports.type = type;
var destroy_1 = __webpack_require__(/*! ./destroy */ "./src/utils/destroy.ts");
Object.defineProperty(exports, "destroyElem", ({ enumerable: true, get: function () { return destroy_1.destroyElem; } }));
Object.defineProperty(exports, "destroyElemByKey", ({ enumerable: true, get: function () { return destroy_1.destroyElemByKey; } }));
var use_html_string_1 = __importDefault(__webpack_require__(/*! ./use-html-string */ "./src/utils/use-html-string.ts"));
exports.useHTMLString = use_html_string_1.default;
var validComps_1 = __importDefault(__webpack_require__(/*! ./validComps */ "./src/utils/validComps.ts"));
exports.validComps = validComps_1.default;
...
function isUseHTMLString(elem, content, use) {
    use ? dom_utils_1.setHtml(elem, content) : dom_utils_1.setText(elem, content);
}
exports.default = isUseHTMLString;
